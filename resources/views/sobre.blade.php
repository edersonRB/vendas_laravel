...
<body class="antialiased">
    ...
    <div class="min-h-screen">
        ...
        <div class="relative d-flex flex-column bg-white sm:items-center py-1 sm:pt-0">
            <div class="p-5 w-50 mt-5">
                <p>
                    Sistema gerenciador de vendas desenvolvido para auxiliar um negócio que precise armazenar
                    diversos produtos e seu histórico de vendas: <br>
                <ul>
                    <li>
                        utiliza para o frontend HTML, CSS, Blade e Bootstrap;
                    </li>
                    <li>
                        Para o backend utiliza PHP+Laravel, ORM Eloquent e o banco de dados MySQL
                    </li>
                </ul>
                </p>
            </div>
